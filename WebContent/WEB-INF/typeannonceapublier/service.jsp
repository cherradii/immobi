	...
	<div id="wrapper">
		...
		<div id="headline">
			...
			<div id="search-news">
				...
				<div id="news-box">
					<div id="search-news">
					<form action ="webannonces?page=/WEB-INF/typeannonceapublier/service.jsp&action1=Authentifier" method="post">
						<table>
							<%		
							...
							%>
							<a href="webannonces?page=/WEB-INF/typeannonceapublier/service.jsp&action1=logout">Deconnexion</a>
							</table>
