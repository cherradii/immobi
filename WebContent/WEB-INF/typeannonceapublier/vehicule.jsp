	...
	<div id="wrapper">
		...
		<div id="headline">
			...
			<div id="photo">
				...
				<form action ="webannonces?page=/WEB-INF/typeannonceapublier/vehicule.jsp&action1=AjouteVehicule" method="post">
				<%
					String vehicule_ok=(String)request.getAttribute("vehicule_ok");
					if(vehicule_ok==null){
				%>
				<table>
					<tr>
						<%
							if (request.getParameter("txtTitreV")=="" || request.getParameter("txtTypeV")=="" || request.getParameter("txtMarque")=="" || request.getParameter("txtAnnonceV")=="" || request.getParameter("txtModele")=="" || request.getParameter("txtDateV")==""){
					...
					<tr >
						...
						<td><input name="txtTitreV" value="<%if(request.getParameter("txtTitreV")!=null) out.println(request.getParameter("txtTitreV")); %>" type="text" size="60">*</td>
					</tr>
					<tr>
						<td>Type de vehicule:</td>
						<td><input name="txtTypeV" value="<%if(request.getParameter("txtTypeV")!=null) out.println(request.getParameter("txtTypeV")); %>" type="text" size="20">*</td>
					</tr>
					<tr>
						<td>Texte de l'annonce:</td>
						<td><TEXTAREA rows="5" cols="40" name="txtAnnonceV"><%if(request.getParameter("txtAnnonceV")!=null) out.println(request.getParameter("txtAnnonceV")); %></TEXTAREA>*</td>
					</tr>
					<tr>
						<td>Marque:</td>
						<td><input name="txtMarque" value="<%if(request.getParameter("txtMarque")!=null) out.println(request.getParameter("txtMarque")); %>" type="text" size="20">*</td>
					</tr>
					<tr>
						<td>Modéle:</td>
						<td><input name="txtModele" value="<%if(request.getParameter("txtModele")!=null) out.println(request.getParameter("txtModele")); %>" type="text" size="20">*</td>
					</tr>
					<tr>
						<td>Date de l'annonce:</td>
						<td><input name="txtDateV" value="<%if(request.getParameter("txtDateV")!=null) out.println(request.getParameter("txtDateV")); %>" type="text" size="20"> jj/mm/aaaa</td>
					</tr>
				</table>
				<table>
					<tr>
			...
			<div id="search-news">
				...
				<div id="news-box">
					<div id="search-news">
					<form action ="webannonces?page=/WEB-INF/typeannonceapublier/vehicule.jsp&action1=Authentifier" method="post">
						<table>
							<%		
							...
							%>
							<a href="webannonces?page=/WEB-INF/typeannonceapublier/vehicule.jsp&action1=logout">Deconnexion</a>
							</table>
