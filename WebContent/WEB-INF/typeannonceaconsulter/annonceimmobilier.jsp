...
<% 
	...
	Integer IdAnnonce =1 ;
	if (request.getParameter("IdAI").equalsIgnoreCase(null)) {
		response.sendRedirect("/GestionAnnonces/webannonces");
	}else{
		IdAnnonce = Integer.parseInt((String)request.getParameter("IdAI"));
	}
%>
			...
			<div id="photo">
				...
				<% 
					if(IdUser==0){
						...
						AnnonceImmobilier Immobilier = new AnnonceImmobilier(IdAnnonce);
						while(Immobilier.rs.next()){
							
							String type = (String)Immobilier.rs.getString(3);
							String adresse = (String)Immobilier.rs.getString(4);
							String ville = (String)Immobilier.rs.getString(5);
							String region = (String)Immobilier.rs.getString(6);
							String pays = (String)Immobilier.rs.getString(7);
							String texte = (String)Immobilier.rs.getString(8);
							String date = (String)Immobilier.rs.getString(12);
							String titre = (String)Immobilier.rs.getString(11);
				%>
					<tr><h1><center>Les informations concernant l'annonce selectionner:</center></h1></tr>	
					<tr bgcolor=#CCCCFF>
						<td>Titre:</td>
						<td><%=titre %></td>
					</tr>
				...
				<a href="webannonces?page=/WEB-INF/typeannonceaconsulter/immobilier.jsp&num=0&nbr=4"><img src="images/retour.png" title="retour"/></a>
				<%}%>	
				<%}%>
			</div>
