			...
			<div id="photo">
				...
				<% 
					if(IdUser==0){
						...
						ProfilUser User = new ProfilUser(ID);
						while(User.rs.next()){
				...
				<p/><p/>
				Les information concernant le propriétaire de l'annonce:
				<br/><br/>
				
				<table Border="1" width=80%>
					
					<tr><h1><center>Les informations concernant le propriétaire de l'annonce:</center></h1></tr>	
					<tr bgcolor=#CCCCFF>
						<td>Nom:</td>
						<td><%=Nom %></td>
					</tr>
