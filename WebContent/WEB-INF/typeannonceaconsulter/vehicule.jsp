		...
		<div id="headline">
			...
			<div id="photo">
				...
				<% 
					...
					AfficheVehicule VehListe =new AfficheVehicule(num,nbr);
        			while(VehListe.rs.next()){
        				
        				String marque = (String)VehListe.rs.getString(3);
						String modele = (String)VehListe.rs.getString(4);
						String type = (String)VehListe.rs.getString(5);
						String texte = (String)VehListe.rs.getString(6);
						
						String date = (String)VehListe.rs.getString(10);
						String titre = (String)VehListe.rs.getString(9);
						
						Integer IdVehicule = VehListe.rs.getInt(1);
						Integer ID = VehListe.rs.getInt(8);
				...
				%>
					...
					<tr  align="center">
						...
						<td bgcolor=#FF9933 align="left" width=110>Titre de l'annonce:</td>
						<td bgcolor=#FFCC66 align="left"><B><a href="webannonces?page=/WEB-INF/typeannonceaconsulter/annonceimmobilier.jsp&IdAI=<%=IdVehicule %>"><%=titre %></a></B></td>
					</tr>
					...
					<%} %>
					<%
						CountVehicule Count =new CountVehicule();
					...
					%>
					<tr><td colspan=3>
					<a href="webannonces?page=/WEB-INF/typeannonceaconsulter/vehicule.jsp&num=<%=num2%>&nbr=<%=nbr %>">
					Précedent
					</a>
					--
					<a href="webannonces?page=/WEB-INF/typeannonceaconsulter/vehicule.jsp&num=<%=num1 %>&nbr=<%=nbr %>">
					Next
					</a>
					</td></td>
			</table>
