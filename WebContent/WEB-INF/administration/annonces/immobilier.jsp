	...
	<div id="wrapper">
		...
		<div id="headline">
			...
			<div id="photo">
				...
				<H4>Le liste des annonces à administrer
					<tr bgcolor=#FFF000 >
					<B>
						<th>Titre</th>
    			...
    			while(ImmListe.rs.next()){
					...
					Integer IdAnnonce = ImmListe.rs.getInt(9);
					Integer IdAI = ImmListe.rs.getInt(1);
				%>
					<tr align="center" valign="middle">
						...
						<td><a href="webannonces?page=/WEB-INF/administration/annonces/immobilier.jsp&action1=deletetoutimmobilier&IdAnnonce=<%=IdAnnonce %>&IdAI=<%=IdAI %>"><img src ="images/supprimer.png"></img></a></td>
					</font>	
					</tr>
				...
				<tr><td colspan="9" align="center">
					<a href="webannonces?page=/WEB-INF/administration/annonces/immobilier.jsp&num=<%=num2%>&nbr=<%=nbr %>">
					Précedent
					</a>
					--
					<a href="webannonces?page=/WEB-INF/administration/annonces/immobilier.jsp&num=<%=num1 %>&nbr=<%=nbr %>">
					Next
					</a>
				</td></tr>
			</table>
